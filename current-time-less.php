...
class Current_Time_Less extends \Jet_Engine\Modules\Dynamic_Visibility\Conditions\Base {
	...
	public function get_name() {
		return __( 'Current time less', 'jet-engine' );
	}
	...
	public function check( $args = array() ) {
		...
		if ( ! $to_check || jet_engine_current_time_skip_day( $time ) ) {
			if ( 'hide' === $type ) {
				return true;
			} else {
				return false;
